...
export const routes: Routes = [
  {
    ...
    children: [
...

      {
        ...
        data: { roles: ['admin', 'shop'] },
        loadComponent: () =>
          import('./features/dashboard/shop/shop-management/shop-management.component').then(
            (m) => m.ShopManagementComponent,
          ),
      },
      {
        path: 'shops',
        loadComponent: () =>
          import('./features/shops/shop-list.component').then((m) => m.PublicShopListComponent),
      },
      {
        path: 'cart',
        canActivate: [roleGuard],
