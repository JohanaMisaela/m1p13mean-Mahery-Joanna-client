...
@Component({
  ...
  template: `
    <div
      class="mb-4 bg-white border border-gray-100 rounded-sm shadow-sm overflow-hidden hover:shadow-md transition-shadow duration-300"
    >
      <!-- Order Card Header -->
      <div
        class="px-8 py-6 border-b border-gray-50 flex flex-wrap justify-between items-center gap-4"
      >
      ...
      <div class="p-8">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-12">
          <!-- Items Preview -->
          <div>
            <h4 class="text-[10px] uppercase tracking-widest text-gray-400 mb-4 font-bold italic">
              Articles
            </h4>
          ...
          <!-- Info Summary -->
          <div
            class="bg-gray-50 p-6 flex flex-col justify-between rounded-sm border border-gray-100"
          >
            <div class="space-y-6">
              <div>
                <h4
                  class="text-[10px] uppercase tracking-widest text-gray-400 mb-3 font-bold italic"
                >
                  Adresse de livraison
                </h4>
                <div class="flex items-start space-x-3">
                  <div
                    class="mt-1 w-6 h-6 bg-white rounded-full flex items-center justify-center border border-gray-100 shadow-sm"
                  >
              ...
              <div class="pt-4 border-t border-gray-200/50">
                <h4
                  class="text-[10px] uppercase tracking-widest text-gray-400 mb-1 font-bold italic"
                >
                  Total payé
                </h4>
                <p class="text-2xl font-light text-gray-900 tracking-tighter">
